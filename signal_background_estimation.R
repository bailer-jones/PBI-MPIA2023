...
##### Version 2023-04. CC-BY-4.0 licence (see README file)
...
write.csv(cbind(xdat,ddat), file="signal_background_estimation.csv", 
...
splot_mean <- signal(xplot, mean_a, mean_b, x0, w, t)
lines(xplot, splot_mean, col="orange3", lwd=2)
points(xdat, ddat)
